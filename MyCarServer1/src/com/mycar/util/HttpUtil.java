...
public class HttpUtil {
	...
	public String sendSms(String type, String phone) {
         ...
         */
		String signature = "【乐乐控】";      //签名
		Random random = new Random();
		String rnum = String.valueOf((int)((Math.random()*9+1)*100000));
		String content = "您的手机验证码是:" +  rnum + "，验证码3分钟内输入有效。如非本人操作，请忽略。" + signature;		//短信内容,请严格按照客服定义的模板生成短信内容,否则发送将失败(含有中文，特殊符号等非ASCII码的内容，用户必须保证其为UTF-8编码格式)		
		try {
